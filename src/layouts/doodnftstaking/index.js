...
function DoodNftStaking() {
  ...
  const approveAllFunc = async () => {
    await usernftContract.setApprovalForAll(config.DOODNFTSTAKINGADDRESS, true).then((tx) => {
      tx.wait().then(() => {
                  ...
                  <Grid item xs={12} xl={6} md={6} mt={6} className="mintFucContainer">
                    <Card>
                      ...
                      {account ? (
                        ...
                        <MDBox pt={3} ml={3} mr={3} mb={3} className="description">
                                  ...
                                  {!stakedState ? (
                                    ...
                                    <>
                                      ...
                                      >
                                        ...
                                        >
                                          <MDTypography variant="h5" className="totlaBalance">
                                      ...
                                      >
                                        ...
                                        >
                                          <MDTypography variant="h5" className="totalBalance">
                                            Total Balance : {totalBalance}
                                          </MDTypography>
                                        </Grid>
                                        <Grid item xs={12} xl={4} md={4}>
